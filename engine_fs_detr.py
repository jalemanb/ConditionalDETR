...
def train_one_epoch(model: torch.nn.Module, criterion: torch.nn.Module,
    ...
    # Samples are the padded images with the respective mask
    # templates is a tuple len -> size of the batch continaing a set of templates per image
    # targets is a tuple with dictionaries containing ['boxes', 'labels', 'image_id', 'area', 'iscrowd', 'orig_size', 'size']
